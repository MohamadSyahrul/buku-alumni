                ...
                <form action="{{ route('prodi.update' , $prodi->id)}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" value="{{$prodi->nama_prodi}}" class="form-control"
                                    name="nama_prodi">
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="row">
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('prodi.update' , $prodi->id)}}" class="form form-horizontal" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                  <div class="modal-body">
                                      ...
                                      <div class="form-group row">
                                          ...
                                          <div class="col-lg-8">
                                              <input type="text" value="{{$prodi->grade}}" class="form-control"
                                                  name="grade" required>
                                          </div>
                                      </div>
                                      <div class="modal-footer">
